...
public sealed record SeriesConfigurationTests
{
    ...
    {
        IMutableProperty property = _entityType.FindProperty(nameof(SeriesEFCoreModel.Id))!;
    ...
    {
        IMutableProperty property = _entityType.FindProperty(nameof(SeriesEFCoreModel.Legend))!;
        Assert.False(property.IsNullable);
    }
    ...
    {
        IMutableProperty property = _entityType.FindProperty(nameof(SeriesEFCoreModel.XAxisSource))!;
        Assert.False(property.IsNullable);
    }
    ...
    {
        IMutableProperty property = _entityType.FindProperty(nameof(SeriesEFCoreModel.YAxisSource))!;
        Assert.False(property.IsNullable);
    }
    ...
    {
        IMutableProperty property = _entityType.FindProperty(nameof(SeriesEFCoreModel.ChartId))!;
        Assert.False(property.IsNullable);
    }
